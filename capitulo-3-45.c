...
int main()
{
	...
	printf("\nEste programa te pedirá tres números y determinará si pueden ser o no lados de un triángulo RECTÁNGULO.");
	while (a != -1 ) {
		...
		if ( a != -1 ){
			if ( a == 0 ){
				...
				if ( b == 0 ) {
					...
					printf("Escribe el valor para el lado C (el mayor): ");
					scanf("%f", &c);
					if ( c == 0 ){
						printf("\nEl lado debe ser mayor a 0.");
						correcto = 0;}
			...
			if ( correcto == 1 )
				if ( a + b == c )
					printf("\nLos lados %.4f, %.4f y %.4f, representan los lados de un triángulo RECTÁNGULO.", a, b, c);	
				else
